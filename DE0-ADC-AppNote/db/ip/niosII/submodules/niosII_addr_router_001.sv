...
(
    ...
    localparam PAD4 = log2ceil(64'h1009040 - 64'h1009020);
    localparam PAD5 = log2ceil(64'h1009050 - 64'h1009048);
    localparam PAD6 = log2ceil(64'h1009058 - 64'h1009050);
    // -------------------------------------------------------
    ...
    always @* begin
        ...
        // ( 0x1009048 .. 0x1009050 )
        if ( {address[RG:PAD5],{PAD5{1'b0}}} == 25'h1009048 ) begin
            src_channel = 7'b0100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 5;
        end

        // ( 0x1009050 .. 0x1009058 )
        if ( {address[RG:PAD6],{PAD6{1'b0}}} == 25'h1009050 ) begin
